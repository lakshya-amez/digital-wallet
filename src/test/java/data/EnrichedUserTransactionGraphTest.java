...
public class EnrichedUserTransactionGraphTest {

    private UserTransactionGraph graph;
    private EnrichedUserTransactionGraph enrichedGraph;
    private Date date = new Date();

    @Before
    public void setUp() {
        graph = UserTransactionGraph.getInstance();
        enrichedGraph = EnrichedUserTransactionGraph.getInstance();
    }
    ...
    public void testGetFriendCircle() {
        ...
        enrichedGraph.enrichUserTransactionGraph();
